...
export function Contact() {
  ...
  return (
    ...
    >
      <h1 className="mb-10 text-3xl font-bold text-white">Contact</h1>
      {showRecaptcha && (
        <Recaptcha
          onChange={(value: any) => {
            setShowRecaptcha(false);
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-16 ">
        <div className="flex items-center gap-8 rounded-md bg-white px-4 py-6">
          <div className="w-[50px] rounded-full bg-back-100 p-4 ">
            <svg
              className="w-full"
          ...
          <div className=" flex flex-col gap-4 text-back-100">
            <h2 className="text-[20px] font-semibold">Appelez nous</h2>
            <p className="text-[16px]">+243 991746590, +243 975436688</p>
          </div>
        </div>
        <div className="flex items-center gap-8 rounded-md border-2 border-solid border-white/80 px-4 py-6">
          <div className="w-[50px] rounded-full bg-white p-4 ">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path
                className="fill-current text-back-100"
      ...
      <div className="mt-8 flex w-full flex-row gap-16">
        <div className="w-full rounded-lg border-2 border-white/50 p-8 md:w-[50%]">
          <div className="flex flex-col md:flex-row md:items-center md:gap-8">
            <Input
              name=""
              label="Nom"
              placeholder=""
              bgColor="mb-4 h-[40px] w-full rounded-md border border-black/20 focus:border-[#616161] bg-white/90"
            ...
            <Input
              ...
              label="Post-nom"
              placeholder=""
              bgColor="mb-4 h-[40px] w-full rounded-md border border-black/20 bg-white/90"
          ...
          <textarea
            placeholder="Message"
            className="mb-4 h-[150px] w-full rounded-md border border-black/20 bg-white/90"
