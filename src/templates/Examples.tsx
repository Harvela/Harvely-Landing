    ...
    <div className="mx-auto flex h-[90%] w-full flex-col gap-6 overflow-x-hidden rounded-2xl bg-primary-300/20 p-4  shadow-sm shadow-black/20 md:h-[100%] md:gap-10 md:p-8">
      <div className="flex flex-col gap-5 rounded-[5px] bg-[#0E9F90]/10 p-5">
        <div className="flex flex-row ">
          <h2 className="rounded-[5px] bg-primary/30 px-3 py-[3px] text-[14px] font-bold text-black md:text-[16px]">
            Lecon: <span> {props.lessonTitle}</span>
          </h2>

          <h3 className="rounded-[5px]  px-3 py-[3px] text-[16px] font-semibold text-black md:text-[16px]">
            Revision:{' '}
